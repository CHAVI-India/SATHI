...
class QuestionnaireItemResponseAdmin(admin.ModelAdmin):
    ...
    search_fields = ('questionnaire_item__item__translations__name', 'questionnaire_submission__patient__name', 'questionnaire_submission__patient__patient_id', 'response_date', 'response_value')
