...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('submission_id', models.UUIDField(blank=True, db_index=True, help_text='The submission id of the response', null=True)),
            ...
            options={
                ...
                'indexes': [models.Index(fields=['submission_id'], name='promapp_que_submiss_ad9393_idx'), models.Index(fields=['patient_questionnaire', 'submission_id'], name='promapp_que_patient_23918d_idx')],
            },
        ),
        migrations.CreateModel(
