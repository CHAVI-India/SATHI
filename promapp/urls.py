...
urlpatterns = [
    ...
    path('schedule-statistics/', views.StatisticsView.as_view(), name='schedule_statistics'),
    ...
    path('export/projects/', 
         views.ProjectExportListView.as_view(), 
         name='project_export_list'),
    path('export/projects/<uuid:project_id>/questionnaires/', 
         views.ProjectQuestionnaireExportListView.as_view(), 
         name='project_questionnaire_export_list'),
